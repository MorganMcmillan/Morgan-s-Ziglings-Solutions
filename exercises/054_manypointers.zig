...
pub fn main() void {
    ...
    const zen12_string: []const u8 = zen_manyptr[0..21]; // slicing an unknown sized pointer like this may be unsafe, as we could end up slicing past the bounds and corructing the program's memory
