...
pub fn main() void {
    ...
    // difference!
    // You can call fields on the structure itself and not just it's instances
    // This allows you to avoid having a self parameter, but any methods with a self will require you to explicitly pass in a valid instance
